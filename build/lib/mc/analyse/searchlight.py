...
16.01.2024:
    ...
    added: cross-validation correlation for searchlights
...
def get_searchlight_RDMs(data_2d, centers, neighbors, events,
                         method='correlation', cv_descr=None, verbose=True):
    ...
    Args:
        ...
        added by S.K. 16.01.2024
        cv_descriptor to allow for cross_corr or crossnobis
    ...
    """
    if cv_descr is not None:
        data_2d = np.concatenate((data_2d['1'], data_2d['2']),0)
