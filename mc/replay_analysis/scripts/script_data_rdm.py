...
SUBJECT_DIRECTORY = Path('/Users/student/PycharmProjects/data/derivatives/' + SUB + '/')
RESULTS_DIRECTORY = Path('/Users/student/PycharmProjects/data/derivatives/' + SUB + '/func/RSA_replay/')
